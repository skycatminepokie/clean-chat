...
public class ChatHandler {
    ...
    ArrayList<ChatFilterSetting> chatFilterSettings = new ArrayList<ChatFilterSetting>();
    @Getter
    ...
    public ChatHandler() {
        for(ChatFilterSetting setting : new ChatFilterSetting[]
                {
            ...
            chatFilterSettings.add(setting);
        }
    }
