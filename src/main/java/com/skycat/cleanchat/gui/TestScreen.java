...
public class TestScreen extends GuiScreen {
    private final OnOffButton myButton = new OnOffButton(1, 100, 100, "button");
    private final GuiTextField guiTextField = new GuiTextField(2, fontRendererObj, 200, 75, 200, 50);
